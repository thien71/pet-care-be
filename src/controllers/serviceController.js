...
class ServiceController {
  ...
  // ==================== PET TYPES ====================
  async getPetTypes(req, res, next) {
    try {
  ...
  async getPublicPetTypes(req, res, next) {
    try {
  ...
  async createPetType(req, res, next) {
    try {
  ...
  async updatePetType(req, res, next) {
    try {
      const { tenLoai } = req.body;
  ...
  async deletePetType(req, res, next) {
    try {
  ...
  // ==================== SYSTEM SERVICES ====================
  async getSystemServices(req, res, next) {
    try {
  ...
  async createSystemService(req, res, next) {
    try {
  ...
  async updateSystemService(req, res, next) {
    try {
  ...
  async deleteSystemService(req, res, next) {
    try {
  ...
  async addServiceToShop(req, res, next) {
    try {
  ...
  async updateShopService(req, res, next) {
    try {
  ...
  async deleteShopService(req, res, next) {
    try {
  ...
  async getAllShopServices(req, res, next) {
    try {
  ...
  async getShopServiceDetail(req, res, next) {
    try {
  ...
  // ==================== SERVICE PROPOSALS ====================
  async proposeNewService(req, res, next) {
    try {
  ...
  async getServiceProposals(req, res, next) {
    try {
  ...
  async approveServiceProposal(req, res, next) {
    try {
  ...
  async rejectServiceProposal(req, res, next) {
    try {
